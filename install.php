							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 required-field-block">
										<input type="text" class="form-control required" name="dbhost" placeholder="localhost" value="<?php echo $dbhost; ?>" <?php echo $attrReadonly; ?> required><input type="text" class="form-control required" name="dbhost" placeholder="localhost" value="<?php echo $dbhost; ?>" required>
									</div>
								</div>
